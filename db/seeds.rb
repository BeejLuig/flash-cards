...
@study_set_1 = @user_2.study_sets.create(title: "Numbers in Spanish", description: "Numbers...in Spanish")
...
@study_set_2 = @user_2.study_sets.create(title: "Distance from the Sun",description: "Distance of planets in our solar system to the sun, in Astronomical Units")
...
@study_set_3 = @user_2.study_sets.create(title: "Common Literary Elements",description: "Literary terms and definitions")
...
@study_set_1 = @user_3.study_sets.create(title: "Musical Terms", description: "Italian terms seen in written music")
...
@study_set_2 = @user_3.study_sets.create(title: "Presidents Term Years",description: "Term years of famous US presidents")
...
@study_set_3 = @user_3.study_sets.create(title: "Android Version Code Names",description:"Nicknames used for major Android releases")
